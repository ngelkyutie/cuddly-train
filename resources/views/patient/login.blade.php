...
<body>
    <div class="login-container">
        <div class="login-section">
            ...
            <form class="login-form" method="POST" action="{{ route('patient.login') }}">
                @csrf
                ...
                <div class="register-link">
                    <p>New patient? <a href="{{ route('patient.registration') }}">Register here</a></p>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // logoImg.innerHTML = '<img src="{{ asset('images/logo.png') }}" alt="ToothTalk Logo" style="width:100%;height:100%;object-fit:cover;border-radius:12px;">';
        });
    </script>
</body>
</html>