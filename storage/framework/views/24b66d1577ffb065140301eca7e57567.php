...
<div class="patient-login-container">
    <div class="login-container">
        <div class="login-section">
            ...
            <form class="login-form" method="POST" action="<?php echo e(route('patient.storeAdvanced')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="login-link">
                    <p>Already have an account? <a href="<?php echo e(route('patient.showLogin')); ?>">Login here</a></p>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\TOOTHTALK_FIXED\resources\views/patient/registration.blade.php ENDPATH**/ ?>